...
const KnowledgeBaseForm = () => {
  ...
  const handleYouTubeSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:8000/admin/youtube/process-channel/",
        {
          method: "POST",
          headers: {
  ...
  const handlePdfUpload = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/admin/pdf/process-pdfs", {
        method: "POST",
        body: formData,
      });
  ...
  const handleSingleUrlSubmit = async () => {
    ...
    const endpoint =
      urlMode === "single"
        ? "http://127.0.0.1:8000/admin/scrapy/scrape"  // Scraping endpoint
        : "http://127.0.0.1:8000/admin/scrapy/crawl";  // Crawling endpoint
